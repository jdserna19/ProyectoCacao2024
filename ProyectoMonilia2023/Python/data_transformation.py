class DataTransformation:
    ...
    def structure_data(self, command, data):
        """Structures the given data according to the kind of data the the given command indicates."""
        data_dictionary = dict()
        if command in self.LOT_DATA:
            data_dictionary = self.structure_lot_data(data)
    ...
    def structure_lot_data(self, lot_data):
        """Structures the given data knowing that it represents lot data"""
        data_dictionary = {
    ...
    def transform_rotary_platforms_angle(self, arduino_rotary_platforms_angle):
        if arduino_rotary_platforms_angle == '':
            arduino_rotary_platforms_angle = -1.0
    ...
    def transform_solenoid_valves_state(self, arduino_solenoid_valves_state):
        if arduino_solenoid_valves_state == '':
            arduino_solenoid_valves_state = -1.0
